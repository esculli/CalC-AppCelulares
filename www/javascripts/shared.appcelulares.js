...
Combis.AppCelulares = Combis.AppCelulares || {
	
	Cargar: function () {
	    $("div#appcelulares").live('click', function () {
			$("#appcelularesmodal").modal().css(
            {
                'margin-top': function () {
		...
		$("button#appcelularesaceptar").live('click', function () {
			var cellphone = $("#appcelularescellphone:checked").val();
			var email = $("#appcelularescellphoneemail").val();
		
			$.post('/appcelulares/data', { cellphone: cellphone, email: email });
			
			$("#appcelularesmodal").modal('hide');
		});
		
	}
};

Combis.AppCelulares.Cargar();
